      ...
      <div className="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-xl bg-white shadow-xl">
        ...
        <Section title="เพิ่ม / แก้ไขบริษัท (เจ้าของ, ผู้จัดการ)">
          <Item label="ข้อมูลพื้นฐาน">
            ...
            ใช้ไอคอนดินสอที่ชื่อผู้รับผิดชอบในแต่ละงานแทน — มุมมองย้อนหลังทุกเดือนจะยังจัดกลุ่ม/นับตามคนที่รับผิดชอบจริง
            ณ เดือนนั้นเสมอ ต่อให้เปลี่ยนผู้รับผิดชอบหลักไปกี่รอบก็ตาม
          </Item>
